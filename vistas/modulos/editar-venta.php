              ...
              <form method="post" class="formularioVenta">
                <div class="card-body">
                  ...
                  <div class="input-group">
                    ...
                    <div class="input-group-append">
                      <span class="input-group-text"><button type="button" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#modalAgregarCliente" data-dismiss="modal">Agregar cliente</button></span>
                    </div>
                  </div>
                  ...
                  <div class="form-group row nuevoProducto">
                    ...
                    <button type="button" class="btn btn-warning btnAgregarProducto">Agregar producto</button>
                  <hr>
